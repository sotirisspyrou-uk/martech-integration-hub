...
Purpose: Standardized connections to all major marketing platforms Impact: 90% reduction in integration development time

+google_search_console_connector.py is a new addition 
